...
const { addtocart, getcartpage, saveItem, getsaveitem, removeitem, addtocart2, transactions, getTransactions } = require("../controllers/addtocart.controller");
...
cart.post("/gettransactions",getTransactions);
module.exports=cart;